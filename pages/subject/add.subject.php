...
<head>
    ...
    <title>Add Subject | BED Taguig</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <form action="userData/ctrl.add.subject.php" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row mb-4 mt-4 ">
                                        ...
                                        <div class="input-group col-md-6 mb-2">
                                            ...
                                            <select class="form-control select2 select2-info custom-select"
                                                ...
                                                <?php
                                                $query = mysqli_query($conn, "SELECT * from tbl_grade_levels WHERE grade_level_id NOT IN (15, 14)");
