...
<head>
    ...
    <title>Edit Adviser | BED Taguig</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <form action="userData/ctrl.edit.adviser.php?ad_id=<?php echo $ad_id;?>" enctype="multipart/form-data" method="POST">
                                    <div class="card-header">
                                        <h3 class="card-title">Adviser Info</h3>
                                        <div class="card-tools">
                                        </div>
                                    </div>
                                    <?php
                                        $adviser_info = mysqli_query($conn, "SELECT * FROM tbl_adviser WHERE ad_id = '$ad_id'");
                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="firstname"
                                                    value="<?php echo $row['ad_fname']?>" placeholder="First name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="lastname"
                                                    value="<?php echo $row['ad_lname']?>" placeholder="Last name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="midname"
                                                    value="<?php echo $row['ad_mname']?>" placeholder="Middle name">
                                            </div>
                                        </div>
