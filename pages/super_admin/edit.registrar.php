...
<head>
    ...
    <title>Edit Registrar | BED Taguig</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Registrar</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <form action="userData/ctrl.edit.registrar.php?reg_id=<?php echo $reg_id;?>" enctype="multipart/form-data" method="POST">
                                    <div class="card-header">
                                        <h3 class="card-title">Registrar Info</h3>
                                        <div class="card-tools">
                                        </div>
                                    </div>
                                    <?php
                                        $registrar_info = mysqli_query($conn, "SELECT * FROM tbl_registrars WHERE reg_id = '$reg_id'");
                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="firstname"
                                                    value="<?php echo $row['reg_fname']?>" placeholder="First name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="lastname"
                                                    value="<?php echo $row['reg_lname']?>" placeholder="Last name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="midname"
                                                    value="<?php echo $row['reg_mname']?>" placeholder="Middle name">
                                            </div>
                                        </div>
