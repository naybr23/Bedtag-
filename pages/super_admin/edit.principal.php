...
<head>
    ...
    <title>Edit Principal | BED Taguig</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Principal</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <form action="userData/ctrl.edit.principal.php?prin_id=<?php echo $prin_id;?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <?php
                                        $principal_info = mysqli_query($conn, "SELECT * FROM tbl_principals WHERE prin_id = '$prin_id'");
                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="firstname"
                                                    value="<?php echo $row['prin_fname']?>" placeholder="First name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="lastname"
                                                    value="<?php echo $row['prin_lname']?>" placeholder="Last name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="midname"
                                                    value="<?php echo $row['prin_mname']?>" placeholder="Middle name">
                                            </div>
                                        </div>
