...
<head>
    ...
    <title>Edit Accounting | BED Taguig</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Accounting</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <form action="userData/ctrl.edit.accounting.php?acc_id=<?php echo $acc_id;?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <?php
                                        $accounting_info = mysqli_query($conn, "SELECT * FROM tbl_accountings WHERE acc_id = '$acc_id'");
                                        while ($row = mysqli_fetch_array($accounting_info)) {
                                    ?>
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="firstname"
                                                    value="<?php echo $row['accounting_fname']?>" placeholder="First name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="lastname"
                                                    value="<?php echo $row['accounting_lname']?>" placeholder="Last name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="midname"
                                                    value="<?php echo $row['accounting_mname']?>" placeholder="Middle name">
                                            </div>
                                        </div>
